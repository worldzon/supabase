---
title: 'Supabase CLI'
subtitle: 'Get started developing locally with the Supabase CLI'
---

You can use the Supabase CLI to run the entire Supabase stack on your machine for local development. The CLI also provides tools to help you deploy to the Supabase Platform, handle database migrations, and generate types directly from your database schema.
